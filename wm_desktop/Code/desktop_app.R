...
artist_data = artist_data_full[1:20,]
    ...
    tabPanel(
      ...
      tagList(
        ...
        tags$details(open = "open",
          ...
          tags$div(HTML("<p>#' DATE STARTED: 8/1/2023<br />#' DATE POSTED: 2/20/2024<br />#' DATE UPDATED: 2/20/2024<br />#' CODING LANGUAGES: R/html, css, javascript<br />#' PACKAGES: spotifyr, shiny, slickR, DT, dplyr, shinyAce</p>"))
        ),
